...
async function layout({ children, params }: Props) {
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-12 w-full md:h-[calc(100vh-6rem)] md:overflow-hidden">
      {userRole || isAdmin ? (
        <>
          ...
          <div className="flex-1 md:col-span-10 md:overflow-hidden min-h-0">
            <div className="grid grid-cols-1 md:h-full px-2 md:px-4">
              {children}
            </div>
          </div>
        </>
