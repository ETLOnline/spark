        ...
        <section className="pt-32 pb-20 px-6 relative">
          <div className="container mx-auto text-center relative z-10">
            ...
            >
              ...
              <span className="text-primary-hover font-bold"> mentors</span>,
              and
                ...
                <CardContent className="p-12">
                  <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                      Customize your community with enterprise-grade tools.
                      Enable features as needed for your specific use case.
                    </p>
                  </div>
                      ...
                      <div className="grid md:grid-cols-3 gap-6">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-muted-foreground">
                            SOC 2 compliance, SSO integration, and advanced
                            access controls
                          </p>
                        </div>
                        <div className="text-center">
        ...
        >
          <div className="container mx-auto">
            ...
            >
              ...
              <p className="text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Modern three-tier architecture ensuring scalability, security,
          ...
          <div className="container mx-auto text-center relative z-10">
            ...
            >
              ...
              <p className="text-2xl text-primary-foreground/80 mb-12 max-w-4xl mx-auto leading-relaxed">
                Join students, mentors, and universities building Pakistan's
