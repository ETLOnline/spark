  ...
  return (
    <>
        ...
        <Container>
          <div className="flex items-center justify-center h-screen w-full ">
            <div className="hero-content ">
              ...
              <p>
                We have our 200 Mentor available, qualified in over 300 subjects
              </p>
              <Button size={"lg"} variant={"outline"} width={"fit"}>
                Find a Mentor
              </Button>
            </div>
      ...
      <div className="section">
        <h2 className="section-title ml-8">Featured Mentors</h2>
        ...
        <div className="section-content">
          <Carousel>
            <CarouselContent className="carousel-content">
              <CarouselItem>
                <MentorCard
                  imgURL="/images/home/Mentor-image1.jpg"
                  imgALT="Tom Jones"
                  title="Tom Jones"
                  duration="200+ hrs"
                />
              ...
              <CarouselItem>
                <MentorCard
                  imgURL="/images/home/Mentor-image2.jpg"
                  imgALT="Holly Fax"
                  title="Holly Fax"
                  duration="100+ hrs"
                />
              ...
              <CarouselItem>
                <MentorCard
                  imgURL="/images/home/Mentor-image3.jpg"
                  imgALT="Valerie"
                  title="Valerie"
                  duration="400+ hrs"
                />
              ...
              <CarouselItem>
                <MentorCard
                  imgURL="/images/home/mentor-image4.jpg"
                  imgALT="James Dean"
                  title="James Dean"
                  duration="200+ hrs"
                />
        ...
        <Container>
          <div className="section">
            ...
            <div className="section-content text-center">
              <p className="pb-4">
                sifting through the overwhelming content on the internet will
                slow you down.break through the <br /> noise abd get specific
        ...
        <div className="section">
          ...
          <div className="section-content">
            <div className="section-content-wrapper justify-around md:justify-between">
              <SkillTag
                imgURL="/images/home/next.png"
                imgALT="react"
                title="react"
              />
              <SkillTag
                imgURL="/images/home/node.png"
                imgALT="Nodejs"
                title="Nodejs"
              />
              <SkillTag
                imgURL="/images/home/graphic.png"
                imgALT="graphic"
            ...
            <div className="section-content-wrapper justify-around">
              <SkillTag
                imgURL="/images/home/java.jpg"
                imgALT="javascript"
                title="JavaScript"
              />
              <SkillTag
                imgURL="/images/home/ux.svg"
                imgALT="ux"
                title="Ux Design"
              />
            </div>
      ...
      <Container>
        <div className="section">
          ...
          <div className="section-card">
            <SessionCard
              imgURL="/images/home/session-image1.jpg"
              title="Everthing Design"
            />

            <SessionCard
              imgURL="/images/home/session-image2.jpg"
              title="Coding Newbies"
            />

            <SessionCard
              imgURL="/images/home/session-image3.jpg"
              title="Project planning"
            />

            <SessionCard
              imgURL="/images/home/session-image4.jpg"
