	...
	return (
		<div className='flex flex-row md:items-center w-full'>
			<div className='w-full fixed md:relative md:w-1/2 '>
				<Image width={500} height={500} quality={100} className='w-full object-cover h-screen md:h-full md:fixed md:top-0 md:w-1/2' src="/images/home/image.jpg" alt="signup-image" />
			</div>
