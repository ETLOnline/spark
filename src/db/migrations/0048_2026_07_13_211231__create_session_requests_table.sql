...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "session_requests" ADD CONSTRAINT "session_requests_availability_slot_id_mentor_availability_id_fk" FOREIGN KEY ("availability_slot_id") REFERENCES "public"."mentor_availability"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
