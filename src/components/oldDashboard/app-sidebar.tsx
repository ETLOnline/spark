...
import NavMain from "@/src/components/oldDashboard/nav-main";
import NavSecondary from "@/src/components/oldDashboard/nav-secondary";
import NavUser from "@/src/components/oldDashboard/nav-user";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
