    ...
    <footer className="py-16 px-6 bg-gray-900 dark:bg-slate-950 text-white">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              Empowering Pakistan's tech future through collaboration, mentorship, and innovation. Building bridges
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; 2024 SPARK Platform. All rights reserved. Built with ❤️ for Pakistan's tech community.</p>
        </div>
      </div>
    </footer>
  )
