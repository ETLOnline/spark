  ...
  return (
    <div className="footer">
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p className="footer-section-text pr-3">
            Empowering growth through mentorship. Connect learn and succed with
            our globalcommunity of mentors.
          </p>
        </div>
        <div className="footer-section">
          ...
          <ul className="footer-nav">
            ...
            <li>
              <Link className="footer-nav-link" href="contact-us">
                contact
              </Link>
            </li>
            <li>
      ...
      <div className="footer-bottom">
        <Separator />
        <p className="footer-section-text text-center my-4">
          2024 Spark. All right reserved
        </p>
      </div>
    </div>
  )
