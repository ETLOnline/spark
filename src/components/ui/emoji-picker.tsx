...
function EmojiPickerSearch({
  ...
  return (
    <div
      className={cn(
        "flex h-9 items-center gap-2 border-b px-3 my-2 pb-2",
        className
      )}
    ...
    >
      ...
      <EmojiPickerPrimitive.Search
        className="p-4 outline-hidden placeholder:text-muted-foreground flex h-10 w-full rounded-md bg-transparent py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50"
