...
function ProjectInformation({ currProjectData }: Props) {
  ...
  const { control, handleSubmit, formState: { errors, isValid } } = useForm<ProjectFormData>({
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Controller
              name="description"
              control={control}
              render={({ field }) => <Textarea id="project-description" {...field} rows={4} />}
            />
          </div>
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <span>{currProjectData.project_type === 'active' ? 'Active' : 'Draft'}</span>
            </div>
          </div>
          {/* <div className="space-y-2">
